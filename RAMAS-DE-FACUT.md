...
| K13 | Sistem automat de curățare care **arhivează** când e gata | ✅ [REZOLVAT] | La închiderea unei cerințe (stare = verificata/respinsa/inchisa/finalizata) sau a unui job (status = done/failed/cancelled), se mută automat în arhivă (`arhivat = true`) și se filtrează din listele active. |
