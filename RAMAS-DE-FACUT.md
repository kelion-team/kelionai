...
| D4 | **Etapa 5b — instalări de sistem ca runbook** | ✅ **implementat** (runbook `instaleaza-pachet-sistem` prin `vps-run.yml` cu validation strictă `isValidSysPackageName` pentru instalări pachete `apt` de sistem). |
