...
| L1l | SUITA DE AGENȚI GOOGLE/GEMINI (Adrian, 3 aug, întrebat de 2 ori): Gemini CLI (agentul oficial de codat, rulează cu GEMINI_API_KEY + cotă gratuită Pro) instalat pe VPS ca LUCRĂTOR în panoul de lucrători + opțiune de creier pentru constructor. Jules (agentul asincron GitHub al Google) = cere legarea contului Google al ownerului, o dată — îi dau pașii când vrea. ADK = framework, nu aduce câștig peste orchestratorul existent | de făcut — primul pas după extirpare |
