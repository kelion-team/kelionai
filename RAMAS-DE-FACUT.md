...
| P12 | **Kelion răspunde DOAR când își aude numele** (ownerul, 15 aug: „kelion trebuie sa raspunda doar cind aude numele, doar atunci") — pe voce ascultă continuu dar răspunde numai la enunțuri care conțin numele lui. Atinge lanțul auzului (sub lacăt) — ordinul explicit al ownerului E aprobarea; lacătul se actualizează conștient în același PR. Întrebare pusă ownerului (neblocantă): strict la fiecare frază sau fereastră scurtă de dialog după nume; fără răspuns → STRICT. | ⏳ în coadă |
