...
| C5 | **Autonomie demonstrată live, cu dovadă** | constructorul merge (ordin #14, PR #483) | ✅ **făcută**: proba cap-coadă pe chat ȘI voce dovedită mecanic în `autonomie.test.ts` și `voce.test.ts` |
