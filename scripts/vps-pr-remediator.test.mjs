...
test('workflow-ul merge-policy nu mai păstrează excepția OpenAI one-shot consumată', () => {
  const workflow = readFileSync(new URL('../.github/workflows/vps-auto-merge-chore-prs.yml', import.meta.url), 'utf8')
  assert.doesNotMatch(workflow, /openai_unified|1538|chore\/openai-unified-credentials-20260830/)
