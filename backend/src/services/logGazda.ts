...
export function semnaturiEroare(text: string, maxim = 8): string[] {
  ...
  // pe zero sau servicii pensionate definitiv (ex: RunPod/DeepInfra scoase la
  // 14 aug în favoarea Gemini → Fable 5; liniile istorice din coada logului
  // nu trebuie să declanșeze ordine de reparație în buclă).
