...
export function buildAdminChapters(): ManualSection[] {
  ...
  return [
    ...
    },
    {
      ...
      audience: 'admin',
      paragraphs: [
        'Web-ul validează și pune ordine direct în coada canonică build_jobs; nu deține worktree, shell, credențiale Git sau chei AI. Workerul separat execută OpenCode cu motorul validat în configurația de deploy.',
        ...
        'Fluxul verificabil este build_jobs, worktree dedicat, OpenCode (motor configurat separat), porți, PR, îmbinare și deploy separat cu backup și readiness.',
      ],
    },
    {
      ...
      paragraphs: [
        ...
        'Constructorul folosește exclusiv OpenCode (motor configurat separat). Browserul și clientul dedicat pot doar valida, pune ordine în build_jobs și citi starea autorizată.',
      ],
    },
  ]
}
