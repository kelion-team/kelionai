  ...
  app.post<{
    ...
    if (isAdmin) {
      ...
      if (bridgeOnline()) {
        ...
        const decision =
          ...
          'NU mai raporta că vezi/citești ceva. Dacă analizezi o imagine, un ecran sau un fișier, interpretează în liniște și răspunde direct — nu începe cu „Văd", „Observ", „I see" sau „I notice".\n\n' +
    ...
    if (!process.env.KELION_API_CHAT && !paysOwnWay) {
      ...
      const pubPrompt =
        ...
        'NEVER announce that you see, read, or observe something. Do not begin replies with phrases like "I see", "I notice", "Văd", "Observ", or "Văd că". You may look or read when needed, but keep that to yourself and answer directly.\n' +
        pubCoords +
