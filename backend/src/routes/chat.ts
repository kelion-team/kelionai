    ...
    if (isAdmin) {
      ...
      if (bridgeOnline()) {
        ...
        const decision =
          ...
          '- SCENARII apelabile (secvențe gata compuse de clipuri + expresie facială ARKit + prioritate): salut, explicatie, multumire, surprindere — folosește [GEST nume_scenariu]. Un scenariu e potrivit când sentimentul/contextul cere o mică „piesă" compusă, nu un singur clip.\n' +
