...
[[ "$(id -un)" == kelion-codex ]] || { echo 'sincronizarea clonei rulează numai ca kelion-codex' >&2; exit 1; }
...
origin=$(env HOME=/var/lib/kelion-codex \
...
config_keys=$(env HOME=/var/lib/kelion-codex \
  GIT_CONFIG_NOSYSTEM=1 GIT_CONFIG_GLOBAL=/dev/null \
...
env HOME=/var/lib/kelion-codex GIT_CONFIG_NOSYSTEM=1 GIT_CONFIG_GLOBAL=/dev/null \
