...
| `bridge.ts` | Puntea: coadă joburi, `pull/ack/reply/reply-chunk`, `authed()`, release gate (`stage-release`, `approved-releases`, `release-deployed`), **alerte release în timp real (`/api/admin/release-alerts`)** pentru banner + voce separat de chat |
