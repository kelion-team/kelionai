...
const dict: Record<Lang, Strings> = {
  en: {
    ...
    chatPlaceholder: 'Message Kelion — start with “Kelion, …”',
    send: 'Send',
  ...
  ro: {
    ...
    chatPlaceholder: 'Scrie-i lui Kelion — începe cu „Kelion, …”',
    send: 'Trimite',
  ...
  es: {
    ...
    chatPlaceholder: 'Escríbele a Kelion — empieza con «Kelion, …»',
    send: 'Enviar',
  ...
  fr: {
    ...
    chatPlaceholder: 'Écrivez à Kelion — commencez par « Kelion, … »',
    send: 'Envoyer',
  ...
  de: {
    ...
    chatPlaceholder: 'Schreib an Kelion — beginne mit „Kelion, …“',
    send: 'Senden',
  ...
  it: {
    ...
    chatPlaceholder: 'Scrivi a Kelion — inizia con «Kelion, …»',
    send: 'Invia',
  ...
  pt: {
    ...
    chatPlaceholder: 'Escreva ao Kelion — comece com «Kelion, …»',
    send: 'Enviar',
