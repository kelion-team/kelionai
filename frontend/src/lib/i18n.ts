...
const dict: Record<Lang, Strings> = {
  en: {
    ...
    landingSub:
      'Talk to Kelion in your own language — ask, show, navigate, create. Try it free for 3 minutes, no sign-up.',
    tryFree: 'Try 3 minutes free',
    trialStarting: 'Starting your free trial…',
    trialLabel: 'Free trial',
    trialOverTitle: 'Your 3 free minutes are up',
  ...
  ro: {
    ...
    landingSub:
      'Vorbește cu Kelion în limba ta — întreabă, arată, navighează, creează. Încearcă gratis 3 minute, fără cont.',
    tryFree: 'Încearcă 3 minute gratis',
    trialStarting: 'Îți pornesc proba gratuită…',
    trialLabel: 'Probă gratuită',
    trialOverTitle: 'Cele 3 minute gratuite s-au terminat',
  ...
  es: {
    ...
    chatError: 'Error.',
    brainNotActive: 'El cerebro aún no está activo (falta la clave de Anthropic).',
    ...
    landingSub:
      'Habla con Kelion en tu idioma — pregunta, muestra, navega, crea. Pruébalo gratis 3 minutos, sin registro.',
    tryFree: 'Prueba 3 minutos gratis',
    trialStarting: 'Iniciando tu prueba gratuita…',
    trialLabel: 'Prueba gratuita',
    trialOverTitle: 'Tus 3 minutos gratis han terminado',
  ...
  fr: {
    ...
    chatError: 'Erreur.',
    brainNotActive: 'Le cerveau n’est pas encore actif (clé Anthropic manquante).',
    ...
    landingSub:
      'Parlez à Kelion dans votre langue — demandez, montrez, naviguez, créez. Essayez gratuitement 3 minutes, sans inscription.',
    tryFree: 'Essayer 3 minutes gratuites',
    trialStarting: 'Démarrage de votre essai gratuit…',
    trialLabel: 'Essai gratuit',
    trialOverTitle: 'Vos 3 minutes gratuites sont écoulées',
  ...
  de: {
    ...
    chatError: 'Fehler.',
    brainNotActive: 'Das Gehirn ist noch nicht aktiv (Anthropic-Schlüssel fehlt).',
    ...
    landingSub:
      'Sprich mit Kelion in deiner Sprache — frag, zeig, navigiere, erschaffe. Teste ihn 3 Minuten gratis, ohne Konto.',
    tryFree: '3 Minuten gratis testen',
    trialStarting: 'Deine Gratis-Probe startet…',
    trialLabel: 'Gratis-Probe',
    trialOverTitle: 'Deine 3 Gratis-Minuten sind um',
  ...
  it: {
    ...
    chatError: 'Errore.',
    brainNotActive: 'Il cervello non è ancora attivo (manca la chiave Anthropic).',
    ...
    landingSub:
      'Parla con Kelion nella tua lingua — chiedi, mostra, naviga, crea. Provalo gratis per 3 minuti, senza registrazione.',
    tryFree: 'Prova 3 minuti gratis',
    trialStarting: 'Avvio della prova gratuita…',
    trialLabel: 'Prova gratuita',
    trialOverTitle: 'I tuoi 3 minuti gratis sono finiti',
  ...
  pt: {
    ...
    chatError: 'Erro.',
    brainNotActive: 'O cérebro ainda não está ativo (falta a chave da Anthropic).',
    ...
    landingSub:
      'Fale com o Kelion no seu idioma — pergunte, mostre, navegue, crie. Experimente grátis por 3 minutos, sem cadastro.',
    tryFree: 'Experimente 3 minutos grátis',
    trialStarting: 'Iniciando o seu teste gratuito…',
    trialLabel: 'Teste gratuito',
    trialOverTitle: 'Os seus 3 minutos grátis acabaram',
